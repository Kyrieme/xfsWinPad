...
#  1. open A08 (233MB; 5526 parts x 992 tests = ~1000 columns)
...
"@
$p = Start-Process -FilePath $ExePath -ArgumentList '--new "D:\AI_Work\codex\xfsPad\temp\A08-LGA2055-V2-25-Test-V5.6_M882KT-U-4_PP21-FT-01_07Dec2024_1339.std"' -PassThru
